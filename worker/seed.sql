-- Gerado por scripts/generate-seed.mjs a partir de src/data/*.ts — rodar uma única vez.

-- members
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Francisco Luciano Pontes', 'PhD Sciences - USP', 'Atualmente é docente do curso de Bacharelado e do programa de pós-graduação em Gerontologia da Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH/USP', 'sdnflkasnflnasdf', 'São Paulo - BR', 'lucianopontes@usp.br', '/files/members/default.png');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Leandro Brasil Rego', 'Pós-Graduação', '', '', 'São Paulo - BR', 'http://lattes.cnpq.br/2489448067323873', '/files/members/default.png');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Ruy Barbosa Martins Calheiros Netto', 'Pós-Graduação', '', 'Possui graduação em Educação Física pela Universidade de Santo Amaro-UNISA, Mestrado em Ciências do Movimento Humano pela Universidade Cruzeiro do Sul-UNICSUL. Atualmente é Professor titular da Universidade Municipal de São Caetano do Sul-USCS e aluno de Doutorado no programa de Pós-Graduação em Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP.', 'São Paulo - BR', 'http://lattes.cnpq.br/7837616003060870', '/files/members/ruy-barbosa.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Taína Costa Nonato', 'Pós-Graduação', '', '', 'São Paulo - BR', 'http://lattes.cnpq.br/4236304464623906', '/files/members/taina-costa.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Rodrigo Chaves da Silva', 'Pós-Graduação', ' ', 'Possui graduação em Gestão Hospitalar pela Universidade Anhembi Morumbi e Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP. Atualmente é pesquisador do Instituto Dante Pazzanese de Cardiologia-IDPC e aluno do Mestrado no Programa de Pós-Graduação em Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP.', 'São Paulo - BR', 'http://lattes.cnpq.br/1665363937150810', '/files/members/default.png');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Lucas Marques Vieira', 'Pós-Graduação', '', 'Possui Graduação em Educação Física pela Universidade Federal de São Paulo-UNIFESP e Residência Multiprofissional na área de Saúde Pública pela Pontifícia Universidade Católica de São Paulo-PC. Atualmente é aluno de Mestrado no Programa de Pós-Graduação em Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP.', 'São Paulo - BR', 'http://lattes.cnpq.br/4996201644508327', '/files/members/lucas-marques.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Ana Paula de Souza Lima', 'Pós-Graduação', ' ', 'Possui graduação em Educação Física pela Universidade Mogi das Cruzes-UMC. Especialização em Algias da Coluna Vertebra pela Faculdade Unileya. Analista de Informações, Cultura e Desporto da Secretaria Municipal de Esportes-PMSP. Atualmente é aluna no Programa de Pós-Graduação em Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP.', 'São Paulo - BR', 'http://lattes.cnpq.br/7065004099846705', '/files/members/ana-paula.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('João Paulo Pinto', 'Pós-Graduação', ' ', 'Possui Graduação em Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP. Especialista MBA em Administração Hospitalar e Sistemas de Saúde pelo Centro Universitário Faculdade de Medicina do ABC, Gestão da Qualidade e Processos pela FM2S Educação Consultoria, Gestão de Projetos e Metodologias Ágeis pela FM2S Educação Consultoria. Atualmente é aluno de Mestrado no programa de Pós-Graduação em Gerontologia pela Escola de Artes, Ciências e Humanidades da Universidade de São Paulo-EACH-USP.', 'São Paulo - BR', 'http://lattes.cnpq.br/8821060836747211', '/files/members/joao-paulo.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Rodrigo Villar', 'Pesquisador', ' ', ' ', ' ', ' ', '/files/members/rodrigo-villar.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Aylton José Figueira Junior', 'Pesquisador', ' ', 'Universidade São Judas Tadeu-USJT. Programa de Pós-graduação em Educação Física', 'São Paulo - BR', 'http://lattes.cnpq.br/1107427417348652', '/files/members/aylton-jose.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Danilo Sales Bocalini', 'Pesquisador', ' ', 'Universidade Federal do Espírito Santo, Centro de Educação Física e Desportos-UFES. Programa de Pós-Graduação em Educação Física.', 'São Paulo - BR', 'http://lattes.cnpq.br/6290090639004596', '/files/members/danilo-sales.jpg');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Felício Savioli Neto', 'Felicio', ' ', 'Instituto Dante Pazzanese de Cardiologia/Setor de Cardiogeriatria', 'São Paulo - BR', 'http://lattes.cnpq.br/1217943416869111', '/files/members/default.png');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Ysis Barreto Donati', 'Graduação', ' ', 'Instituto Dante Pazzanese de Cardiologia/Setor de Cardiogeriatria', 'São Paulo - BR', 'http://lattes.cnpq.br/1217943416869111', '/files/members/default.png');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Barbara Rafaela Rubino da Silva', 'Graduação', ' ', 'Instituto Dante Pazzanese de Cardiologia/Setor de Cardiogeriatria', 'São Paulo - BR', 'http://lattes.cnpq.br/1217943416869111', '/files/members/default.png');
INSERT INTO members (name, subtitle, teaser, bio, location, links, image_url) VALUES ('Eloa Silva Lira', 'Graduação', ' ', 'Instituto Dante Pazzanese de Cardiologia/Setor de Cardiogeriatria', 'São Paulo - BR', 'http://lattes.cnpq.br/1217943416869111', '/files/members/default.png');

-- resources
INSERT INTO resources (title, description, download_url, upload_year_month, tag) VALUES ('Planilha de Coleta de Dados.xlsx', 'Modelo de planilha para coleta de dados de VO2 máximo.', NULL, '2025-09', 'Disciplina de Pós-Graduação');
INSERT INTO resources (title, description, download_url, upload_year_month, tag) VALUES ('Artigo sobre Fisiologia do Esforço.pdf', 'Publicação sobre as adaptações cardiovasculares.', '/files/resources/artigo-fisiologia-esforco.pdf', '2025-09', 'Disciplina de Pós-Graduação');
INSERT INTO resources (title, description, download_url, upload_year_month, tag) VALUES ('Apresentação sobre Biomecânica.pptx', 'Slides da apresentação do último congresso da equipe.', NULL, '2025-09', 'Congresso');

-- publications
INSERT INTO publications (bibtex_key, bibtex_raw) VALUES ('Evangelista2024', '@article{Evangelista2024,
...
INSERT INTO publications (bibtex_key, bibtex_raw) VALUES ('Pontes2024', '@article{Pontes2024,
...
INSERT INTO publications (bibtex_key, bibtex_raw) VALUES ('Siqueira2024', '@article{Siqueira2024,
...
INSERT INTO publications (bibtex_key, bibtex_raw) VALUES ('daSilveira2025', '@article{daSilveira2025,
...
INSERT INTO publications (bibtex_key, bibtex_raw) VALUES ('Rego2025', '@article{Rego2025,
...
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/default.png', 'Default.png', 31740, 'image/png');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/ruy-barbosa.jpg', 'Ruy_barbosa.jpg', 7069, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/taina-costa.jpg', 'Taina_costa.jpg', 20477, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/lucas-marques.jpg', 'Lucas_marques.jpg', 13049, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/ana-paula.jpg', 'Ana_paula.jpg', 4757, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/joao-paulo.jpg', 'Joao_paulo.jpg', 16464, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/rodrigo-villar.jpg', 'Rodrigo_villar.jpg', 9373, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/aylton-jose.jpg', 'Aylton_jose.jpg', 16585, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('members/danilo-sales.jpg', 'Danilo_sales.jpg', 9856, 'image/jpeg');
INSERT INTO files (r2_key, original_name, size, mime_type) VALUES ('resources/artigo-fisiologia-esforco.pdf', 'artigo-fisiologia-esforco.pdf', 44562, 'application/pdf');
